...
academia_df = pd.read_csv(
    r"C:\Users\Pichau\Downloads\database_acad.txt"
)
...
plt.savefig("grafico_receita_aluno.png")
plt.show()
...
plt.savefig("grafico_receita_modalidade.png")
plt.show()
...
with pd.ExcelWriter("Relatorio_Academia.xlsx") as writer:
